...
import 'package:unibeethree/screen/viewDriverProfile.dart';
...
class _driverProfileState extends State<driverProfile> {
  ...
  void initState() {
    super.initState();
    print(user.toString() + "jdjjdjdjdj");
  }
  ...
  void deleted({
    ...
    try {
      FirebaseFirestore.instance.collection("drivers").doc(id).delete();
      var cred =
    ...
    //     title: 'You have ongoing trips! you can\'t delete your account.',
    //     btnOkOnPress: () {},
    //   ).show();
    //   // hasOngoing = false;
    // }
